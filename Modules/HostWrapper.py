...
def getSWInfo(RESPONSE_FILEARRAY,SW,ScanDateforSQL,USESQL):
    #Start SW data
    cols = ["SCANDATEFORSQL","HOST_ID","ASSET_ID","SW_NAME","SW_Type","category1","category2","productName","component","publisher","marketVersion","installDate","lastUpdated","gaDate","eolDate","eosDate","stage","lifeCycleConfidence","eolSupportStage","eosSupportStage","licensCategory","licensSubcategory"]
    rows = []
